...
class Question2:
    def __init__(self, dimes_and_quarters=None):
        ...
        if dimes_and_quarters is None:
            self.dimes_and_quarters = {}
        else:
            self.dimes_and_quarters = dimes_and_quarters

        self.dimes = self.dimes_and_quarters.get("dimes", 0)
        self.quarters = self.dimes_and_quarters.get("quarters", 0)
    ...
    def add_coins(self, dimes_and_quarters):
        ...
        """
        dimes_added = dimes_and_quarters.get("dimes", 0)
        quarters_added = dimes_and_quarters.get("quarters", 0)

        self.dimes += dimes_added
        self.quarters += quarters_added
    ...
    def remove_coins(self, dimes_and_quarters):
        ...
        dimes_removed = dimes_and_quarters.get("dimes", 0)
        quarters_removed = dimes_and_quarters.get("quarters", 0)

        # should I handle negative values?
        self.dimes -= dimes_removed
        self.quarters -= quarters_removed
    ...
    def get_coins(self):
        ...
        """
        ans = {"dimes": self.dimes, "quarters": self.quarters}
        return ans
    ...
    def get_balance_cents(self):
        ...
        """
        dimes_count = self.dimes * 10
        quarters_count = self.quarters * 25

        return dimes_count + quarters_count
...
def q1_check(functions, arguments):
    ...
    try:
        account = Question1()
        method_mapping = {
            "getBalance": account.get_balance,
...
def q2_check(functions, arguments):
    ...
    try:
        account = Question2()
        method_mapping = {
            "__init__": account.__init__,
            "addCoins": account.add_coins,
            "removeCoins": account.remove_coins,
            "getBalanceCents": account.get_balance_cents,
...
def q4_check(functions, arguments):
    ...
    try:
        account = Question4(
            arguments[0]
        )  # implicitly assume first call is always to init, with appropriate parameter
...
CODE_TEST_CASES = (
    ...
    },
    {
        ...
        "expected_output": [
            None,
            "(Customer: Alex, Balance: 300)(Customer: Bob, Balance: 50)",
        ],
        "outputs_match_func": compare_outputs,
        "output_to_str_func": str(),
        "points_avail": 1,
    },
    {
        ...
        "expected_output": [
            None,
            "(Customer: Alexa, Balance: 300)(Customer: Siri, Balance: 130)",
        ],
        "outputs_match_func": compare_outputs,
        "output_to_str_func": str(),
        "points_avail": 1,
